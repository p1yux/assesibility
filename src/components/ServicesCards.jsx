  ...
  const services = [
    {
      ...
      description: "Comprehensive evaluations of websites and apps against WCAG 2.1/2.2 standards, combining automated scans and expert manual testing including assistive tech users.",
      features: [
    ...
    },
    {
      ...
      description: "Hands-on support to fix accessibility issues or guide your team in implementing inclusive code practices — all aimed at achieving WCAG Level AA compliance.",
      features: [
    ...
    },
    {
      ...
      description: "Continuous accessibility tracking through subscription-based tools to catch issues early, ensure updates stay compliant, and validate real-world usability with expert oversight.",
      features: [
    ...
    },
    {
      ...
      description: "Empowering teams with the knowledge and strategies to build inclusive digital experiences through hands-on training and expert consulting support.",
      features: [
    ...
    },
    {
      ...
      description: "Support for inclusive, accessible communication through accessible media, document conversion, and assistive tech compatibility testing and validation.",
      features: [
    ...
    },
    {
      ...
      description: "Accelerate accessibility with smart, scalable tools like browser plugins, API integrations, and AI-driven solutions that streamline testing and remediation.",
      features: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {services.map((service, index) => (
            <div 
              key={index} 
              className={`p-6 rounded-lg ${index % 2 === 0 ? 'bg-gray-50' : 'bg-red-100'}`}
            >
              <h3 className="text-lg text-[#1E1E1E] font-semibold mb-2">{service.title}</h3>
              ...
              <ul className="space-y-1">
                {service.features.map((feature, featureIndex) => (
                  <li key={featureIndex} className="flex items-start text-sm">
                    <span className="text-red-700 mr-2 text-xs">►</span>
