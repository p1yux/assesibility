      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-4 lg:px-6 py-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="flex items-center">
            <Link href="/" className="h-20 w-32" aria-label="Accessibility - Homepage">
            ...
            <div className="flex mb-6">
              <input 
                ...
                className="bg-gray-800 text-white px-4 py-2 rounded-l-md w-full focus:outline-none focus:ring-1 focus:ring-red-800"
                aria-label="Email address for newsletter"
              />
              <button 
                className="bg-gray-800 px-3 py-2 rounded-r-md border-l border-gray-700"
