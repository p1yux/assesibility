...
const ServicesClients = () => {
  ...
  return (
    <section className="py-12 bg-white">
      ...
      <h1 className="text-4xl font-bold text-[#1E1E1E] mb-4">Who We Serve</h1>
        <div className="flex flex-col md:flex-row md:items-start gap-8">
          ...
          <div className="md:w-5/12">
            ...
            <div className="md:w-full grid grid-cols-1 gap-4 mt-5">
              {industries1.map((industry, index) => (
          ...
          <div className="md:w-7/12 grid grid-cols-1 gap-6">
            {industries.map((industry, index) => (
              <div key={index} className="flex items-start">
                ...
                <div>
                  <h2 className="text-base font-semibold text-[#1E1E1E] mb-1">{industry.title}</h2>
                  <p className="text-gray-600 text-lg">{industry.description}</p>
                </div>
              </div>
            ))}
            <p className="mt-5 text-gray-600 text-sm border border-gray-300 rounded-3xl p-10 bg-[#F6E8E8]">Whether you're a public institution or a private enterprise, Enable Canada is here to support your journey toward digital inclusivity.</p>
          </div>
        </div>
