...
const Features = () => {
  const features = [
    ...
    },
    {
      ...
      description: "We optimize your digital products for keyboard-only users, ensuring all functionality is accessible without a mouse.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
    ...
    },
    {
      ...
      description: "Our commitment doesn't end with implementation. We provide continued monitoring and maintenance to ensure long-term accessibility.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
    ...
    },
    {
      ...
      description: "We empower your team with knowledge and skills to maintain accessibility best practices long after our collaboration.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
